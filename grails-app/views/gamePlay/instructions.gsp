<!DOCTYPE html>
    ...
    <asset:stylesheet href="files/instructions/instructions.css" />
    ...
    <asset:javascript src="files/instructions/instructions.js"/>
    ...
    <asset:stylesheet src="instructions.css"/>
    ...
    <asset:javascript src="instructions.js"/>

    <script>
    responsiveVoice.speak("please find card number ${cardNumber} and place it on the tray.  Press the checkmark to start.");
    </script>
